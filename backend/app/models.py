...
class Unidade(Base):
    ...
    itens = relationship("Item", back_populates="unidade", cascade="all, delete-orphan")
    __table_args__ = (UniqueConstraint("empresa_id", "id_unidade", name="uq_unidade_por_empresa"),)
...
class Item(Base):
    ...
    __table_args__ = (UniqueConstraint("unidade_id", "id_item", name="uq_item_por_unidade"),)
